...
public class AddCourseGUI extends javax.swing.JFrame {
    ...
    public AddCourseGUI() {
        ...
        LinkedList<Course> cour = PlagCheckSystem.getCourses(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select Course from List :");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        course.addToUserList(LoginGUI.getUser());
        LoginGUI.getUser().addToCourseList(course);
        JOptionPane.showMessageDialog(null, "You are enrolled now");
